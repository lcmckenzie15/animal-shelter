            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form class="requires-validation form-rounded" novalidate v-on:submit.prevent="updatePet">
                            <div class="col-md-12 mb-4">
                                <label for="species" class="form-label">Species:</label>
                                <select class="form-select" id="species" v-model="pet.species">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <select class="form-select" id="gender" v-model="pet.gender">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="number" class="form-control" id="age" min="1" max="20"
                                    v-model="pet.age">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="text" class="form-control" id="name" v-model="pet.name">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="text" class="form-control" id="breed" v-model="pet.breed">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <select class="form-select" id="size" v-model="pet.petSize">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="text" class="form-control" id="color" v-model="pet.color">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <textarea class="form-control" id="description" rows="3"
                                    v-model="pet.description"></textarea>
                                <div class="valid-feedback">Description is valid!</div>
                                <div class="invalid-feedback">Please enter a description.</div>
                            </div>

                            <input type="file" id="picture" name="picture-upload" v-on:click.prevent="openUploadWidget"
                                >
                            {{ pet.profilePic }}
...
export default {
    ...
    methods: {
        ...
        updatePet() {
            PetService.updatePetListing(this.$route.params.id, this.pet).then((response) => {
